# RailsAdmin config file. Generated on August 25, 2012 17:03
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Idevlove', 'Admin']
  ...
  # config.excluded_models = [Admin, Attendance, Event, EventMessage, Friend, Introduction, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Admin, Attendance, Event, EventMessage, Friend, Introduction, User]
